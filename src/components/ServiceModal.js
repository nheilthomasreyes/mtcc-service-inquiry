    ...
    categories: [
      {
        ...
        items: [
          { name: 'Digital Thermometer (-45°C to 150°C)', 
            price: '₱800.00', 
            details: 'High-precision digital temperature measurement \
            \n\n Per Additional point/s: ₱150.00 \
            \n Per Additional Probe: ₱800.00' },

          { name: 'RTD Probe/Wire Stand', 
            price: '₱1,300.00', 
            details: 'Resistance Temperature Detector calibration \
            \n\n Per Additional points: ₱450.00' },
      
          { name: 'Liquid Glass Thermometer', 
            price: '₱1,000.00', 
            details: 'Traditional mercury and alcohol thermometers \
            \n\n Per Additional point/s: ₱350.00 \
            \n Additional Charge if any test of test temperature is below 20°C: ₱180.00 \
            \n Per Additional glass Thermometer: ₱800.00 ' },

          { name: 'Thermocouple with Indicator', 
            price: '₱1,600.00',
            details: 'Industrial temperature sensing devices' },

          { name: 'Thermocouple probe/wire (1 to 4 points)', 
            price: '₱800.00',
            details: 'Industrial temperature sensing devices \
            \n\n Per Additional point/s: ₱180.00' },
            
          { name: 'Infrared Thermometer', 
            price: '₱2,240.00', 
            details: 'Non-contact temperature measurement' },
        ],
      },
      {
        ...
        items: [
          { name: 'Pressure Gauge ≤ 500 psi', 
            price: '₱250.00', 
            details: 'Low pressure range calibration' },

          { name: 'Pressure Gauge > 500 psi', 
            price: '₱300.00', 
            details: 'Medium pressure range calibration' },

          { name: 'Pressure Gauge > 1000 psi', 
            price: '₱500.00', 
            details: 'High pressure range calibration' },

          { name: 'Pressure Gauge > 2000 psi', 
            price: '₱900.00', 
            details: 'Extra high pressure calibration' },

          { name: 'Pressure Gauge > 5000 psi', 
            price: '₱1,500.00', 
            details: 'Extra high pressure calibration' },

          { name: 'Sphygmomanometer', 
            price: '₱840.00', 
            details: 'Medical blood pressure devices' },
        ],
      },
      {
        ...
        items: [
          { name: 'Oscilloscope Up to 100MHz', 
            price: '₱4,000.00', 
            details: 'Waveform measurement and analysis' },

          { name: 'Oscilloscope 100MHz to 1GHz', 
            price: '₱8,000.00', 
            details: 'High-frequency signal analysis' },

          { name: 'Power Supply Up to 30V/5A', 
            price: '₱3,000.00', 
            details: 'DC power source calibration' },

          { name: 'Function Generator Up to 10 MHz', 
            price: '₱3,550.00', 
            details: 'Signal generation calibration' },

          { name: 'Function Generator Up to 10 Hz to 50 Hz', 
            price: '₱4,800.00', 
            details: 'Signal generation calibration' },
          
          { name: 'Multimeter Analog', 
            price: '₱1,500.00', 
            details: 'Precision measurement instruments' },

          { name: 'Multimeter Digital (3-7 digits)', 
            price: '₱2,000.00 - ₱8,000.00', 
            details: 'Precision measurement instruments' },
        ],
      },
    ],
    ...
    categories: [
      {
        ...
        items: [
          { name: 'UTM - Tensile Strength Test', 
            price: '₱250.00 - ₱450.00', 
            details: 'Measure maximum stress material can withstand while being stretched' },

          { name: 'UTM - Compression Test', 
            price: '₱250.00', 
            details: 'Determine material behavior under compressive loads' },

          { name: 'UTM - Flexural Test', 
            price: '₱250.00 - ₱450.00', 
            details: 'Evaluate bending strength and flexibility' },

          { name: 'UTM - Bending Test', 
            price: '₱250.00 - ₱450.00', 
            details: 'Assess ductility and resistance to bending' },

          { name: 'Hardness Test', 
            price: '₱300.00', 
            details: 'Measure material resistance to deformation' },
        ],
      },
      {
        ...
        items: [
          { name: 'Moisture Test', 
            price: '₱250.00', 
            details: 'Determine water content in materials' },
          { name: 'UV Light Test', 
            price: '₱300.00', 
            details: 'Assess material degradation under UV exposure' },
          { name: 'Coating Thickness Test', 
            price: '₱280.00', 
            details: 'Measure protective coating thickness' },
          { name: 'FTIR Spectrometer Analysis', 
            price: '₱500.00 - ₱800.00', 
            details: 'Identify chemical composition and structure' },
          { name: 'UV-VIS Spectroscopy', 
            price: '₱1,000.00+', 
            details: 'Analyze optical and electronic properties' },
        ],
      },
      {
        ...
        items: [
          { name: 'Centrifuge (Biotechnology)', 
            price: '₱150.00 - ₱500.00/hour', 
            details: 'Separate substances by density' },
          { name: 'Ultracentrifuge', 
            price: '₱500.00 - ₱750.00/hour', 
            details: 'High-speed separation for research' },
          { name: 'Rotary Evaporator', 
            price: '₱500.00 - ₱750.00/hour', 
            details: 'Efficient solvent removal' },
          { name: 'Freeze Dryer', 
            price: '₱400.00 - ₱600.00/hour', 
            details: 'Lyophilization for sample preservation' },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        items: [
          { name: 'Advanced Testing Laboratory Access', 
            price: 'Contact for quotation', 
            details: 'Full access to our modern laboratory facilities' },
          { name: 'Research Consultation Services', 
            price: 'Contact for quotation', 
            details: 'Expert guidance for your research projects' },
          { name: 'Equipment Rental for Research', 
            price: 'Contact for quotation', 
            details: 'Hourly or daily rental of specialized equipment' },
          { name: 'Data Analysis Support', 
            price: 'Contact for quotation', 
            details: 'Professional data interpretation and analysis' },
          { name: 'Sample Preparation Services', 
            price: 'Contact for quotation', 
            details: 'Professional sample handling and preparation' },
        ],
      },
      {
        ...
        items: [
          { name: 'Product Development Support', 
            price: 'Contact for quotation', 
            details: 'From concept to final product testing' },
          { name: 'Quality Assurance Programs', 
            price: 'Contact for quotation', 
            details: 'Comprehensive QA/QC implementation' },
          { name: 'Testing Protocol Development', 
            price: 'Contact for quotation', 
            details: 'Custom testing procedures for your needs' },
          { name: 'Technical Documentation', 
            price: 'Contact for quotation', 
            details: 'Professional technical writing and reports' },
          { name: 'Collaborative Research Projects', 
            price: 'Contact for quotation', 
            details: 'Joint research initiatives with industry partners' },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        items: [
          { name: 'Equipment Operation Training', 
            price: 'Contact for quotation', 
            details: 'Hands-on training for laboratory equipment' },
          { name: 'Calibration Procedures Workshop', 
            price: 'Contact for quotation', 
            details: 'Learn standard calibration protocols' },
          { name: 'Material Testing Techniques', 
            price: 'Contact for quotation', 
            details: 'Master various testing methodologies' },
          { name: 'Laboratory Safety Training', 
            price: 'Contact for quotation', 
            details: 'Essential safety protocols and practices' },
          { name: 'Quality Management Systems', 
            price: 'Contact for quotation', 
            details: 'ISO standards and implementation' },
          { name: 'Data Recording & Analysis', 
            price: 'Contact for quotation', 
            details: 'Proper documentation and analysis methods' },
        ],
      },
      {
        ...
        items: [
          { name: 'Calibration Technician Certification', 
            price: 'Contact for quotation', 
            details: 'Accredited calibration specialist program' },
          { name: 'Material Testing Certification', 
            price: 'Contact for quotation', 
            details: 'Certified testing professional program' },
          { name: 'Laboratory Quality Manager', 
            price: 'Contact for quotation', 
            details: 'Advanced quality management certification' },
          { name: 'Equipment Operator Certification', 
            price: 'Contact for quotation', 
            details: 'Specialized equipment handling credentials' },
        ],
      },
    ],
  },
